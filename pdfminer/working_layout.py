import heapq
import logging
from typing import NamedTuple, List, Text, NoReturn, Tuple
...
class LAParams(_LAParams):
    ...
    def __new__(self, *args, **kwargs) -> object:
        "Return  if boxes_flow is within the range of -1.0 and 1.0"
...
class LTCurve(LTComponent):
    ...
    fill: bool = False
    evenodd: bool = False
    stroking_color: bool = None
    non_stroking_color: bool = None

    def __post_init__(self) -> NoReturn:
        LTComponent.__init__(self, get_bound(self.pts))

    def get_pts(self) -> Text:
...
class LTLine(LTCurve):
    ...
    def __init__(self, linewidth: float, p0: float, p1: float,
                 *args, **kwargs) -> NoReturn:

        LTCurve.__init__(self, linewidth, [p0, p1],  *args, **kwargs)
...
class LTRect(LTCurve):
    ...
    def __init__(self, linewidth: float, bbox: Box,
                 *args, **kwargs) -> NoReturn:
